...
ggplot(monthyear, aes(month, year, fill=count)) + geom_tile()+ theme_classic()+ ggtitle("Number of distinct clients served overtime by month and year")
...
ggplot(total, aes(fill=Service, y=Quantity, x=year)) + 
  geom_bar(position="stack", stat="identity")+ xlab("Year") + ylab("Number of People/Families")+ggtitle("Number of distinct clients by types of service over the years ")+scale_fill_brewer(palette = "Paired")
```
